...
$(document).ready(function () {
    ...
    $('#btnModal').on('click', function () {
        ...
        document.getElementById('labelModal').innerText = "Create Role";
        document.getElementById('modal-body').innerHTML = "<object id='modal-container' width='100%' height='200' data='contents/forms/roles/createRoleForm.php'> </object>";
    })
    ...
    for (var i = 0; i < btnEdit.length; i++) {
        btnEdit[i].onclick = function (){
            ...
            document.getElementById('labelModal').innerText = "Edit Role";
            document.getElementById('modal-body').innerHTML = "<object id='modal-container' width='100%' height='200' data='contents/forms/roles/updateRoleForm.php?id="+this.name+"'> </object>";
    ...
    for (var i = 0; i < btnDelete.length; i++) {
        btnDelete[i].onclick = function (){
            ...
            if (answer){
                location.href = "handlers/roles/rolesHandler.php?action=delete&id="+this.name+"";
            }else{
    ...
    for (var i = 0; i < btnSearch.length; i++) {
        btnSearch[i].onclick = function (){
            ...
            location.href = "index.php?page=roles&parameter="+ $param;
        }
    }
});